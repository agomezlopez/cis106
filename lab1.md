...
3. Which processor architecture does it support?  
   * **armf, i686, powerpc, ppc64el, s390x, x86_64**
...
1. What is the name of the distribution and the OS Type: 
   * **Porteus and is on Linux OS type**
...
* Website: **https://en.altlinux.org/ (English) https://www.basealt.ru/ (Russian)**
...
**Br OS says that if you know how to use widows then it should be easy to use which could be great since many people are windows users. On the contrary OS does have a MacOS feel and similar look. Looking at the screenshots even the file explorer looks similar to MacOS finder. Comes with a free download of office which can be great for many people who do use the software. OS does not take a lot of resources so it can focus on its look.**
